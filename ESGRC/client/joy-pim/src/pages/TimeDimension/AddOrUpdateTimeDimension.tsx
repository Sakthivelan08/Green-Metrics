import { Compliance, TimeDimension } from '@/services/ApiClient';
...
export default function AddOrUpdateTimeDimension(
  props: Readonly<{
    SelectedUser: any;
    recordId: number;
    ClosePopup: () => void;
  ...
  const onSubmit = async (data: FormData) => {
    ...
    const Timedata: any = new TimeDimension({
      name: data.name,
    ...
    try {
      await apiClient.addOrUpdateTimeDimension(Timedata);
