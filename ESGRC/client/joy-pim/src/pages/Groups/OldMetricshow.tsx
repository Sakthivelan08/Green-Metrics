...
class OldMetricshow extends React.Component<any, any> {
  ...
  async refresh() {
    try {
      ...
      const apiResponse1: any = (await this.apiClient.getMetricshow(this.state.groupid)).result;
...
const ComponentTranslated: any = withTranslation()(OldMetricshow);
