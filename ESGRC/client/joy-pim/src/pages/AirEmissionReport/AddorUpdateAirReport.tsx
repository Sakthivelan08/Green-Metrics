...
import UploadDataAir from './UploadDataAir';
...
export default function AddOrUpdateAirReports(props: AddOrUpdateReports) {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      await apiClient.addAirEmissionPdfReport(body).then(() => {
